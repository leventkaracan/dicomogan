...
from dicomogan.modules.model import MultiscaleDiscriminatorPixpixHDMFMOD
from dicomogan.modules.model import MappingNetworkVAE, Generator2, TextEncoder, EncoderVideo_LatentODE, Decoder,LatentODEfunc
...
parser.add_argument('--manualSeed', type=int, default=107, help='manual seed')
