...
class DiCoMOGANCLIP(pl.LightningModule):
    ...
    def sample_frames(self, mean_inversion, condition_vector):
        ...
        w_latents = self.style_mapper(src_inversion, [condition_vector, condition_vector, condition_vector])
    ...
    def training_step(self, batch, batch_idx):
        ...
        w_latents = self.style_mapper(src_inversion, [conditional_vector, conditional_vector, conditional_vector])
        w_latents_txt_mismatched = self.style_mapper(src_inversion, [conditional_vector_mismatched, conditional_vector_mismatched, conditional_vector_mismatched])
