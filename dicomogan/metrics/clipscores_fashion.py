...
#dir = "/data/levent/sisgantagan/sisgan-fashion/target_100/"
#dir = "/data/levent/manigan/output/fashion_ManiGAN_2021_11_09_21_48_39/Model/netG_epoch_75/target/"
dir = "/data/levent/results_fashion_textvae2im/target/"
l1_loss = nn.L1Loss()
cos_sim = nn.CosineSimilarity()
scores = []
filet = open("fashion_textvaecond_clip_mp.txt", "w")
for i in range(500):
  for j in range(12):
